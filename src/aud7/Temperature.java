...
public class Temperature {
    ...
    static class MyKeyForOBHT{
        ...
        public boolean equals(Object obj) {
            return obj instanceof MyKeyForOBHT other
                    && this.name.equals(other.name);
        }
        public boolean equals(MyKeyForOBHT other){
    ...
    static class MyKey implements DoublyHashable<MyKey> {
        ...
        public boolean equals(Object obj) { return obj instanceof MyKey other && this.name.equals(other.name); }
    }
